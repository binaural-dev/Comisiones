...
class ResConfigSettingsBinauralInventario(models.TransientModel):
	...
	not_account_purchase = fields.Boolean(string='Apagar asiento de valoración en compras')
	not_account_sell = fields.Boolean(string='Apagar asiento de valoración en ventas')
	...
	def set_values(self):
		...
		self.env['ir.config_parameter'].sudo().set_param('not_account_purchase', self.not_account_purchase)
		self.env['ir.config_parameter'].sudo().set_param('not_account_sell', self.not_account_sell)
	...
	def get_values(self):
		...
		res['not_account_purchase'] = self.env['ir.config_parameter'].sudo().get_param('not_account_purchase')
		res['not_account_sell'] = self.env['ir.config_parameter'].sudo().get_param('not_account_sell')
		return res
