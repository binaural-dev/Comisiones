...
class BookPurchaseReport(models.TransientModel):
    ...
    def _shopping_book_invoice(self):
        ...
        for i in docs:
            ...
            if i.move_type in ['in_invoice', 'in_refund'] and i.state in ['cancel']:
                dict['Tipo Transacción'] = '03-ANU'
            if i.move_type == 'in_refund' and i.state in ['posted']:
                dict['Tipo Transacción'] = '03-REG'
            if i.move_type == 'in_debit' and i.state in ['posted']:
                dict['Tipo Transacción'] = '02-REG'
            if i.move_type == 'in_debit' and i.state in ['cancel']:
                dict['Tipo Transacción'] = '02-ANU'
