# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'account', 'binaural_contactos_configuraciones', 'account_accountant', 'binaural_currency_extend', 'account_asset','binaural_inventario', 'account_debit_note'],
