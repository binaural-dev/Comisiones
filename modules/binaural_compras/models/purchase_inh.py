    ...
    def _compute_invoice_taxes_by_group(self):
        ...
        for move in self:
            ...
            for line in tax_lines:
                ...
                res[line.taxes_id.tax_group_id]['foreign_base'] += tax_balance_multiplicator * \
                ...
                res[line.taxes_id.tax_group_id]['foreign_amount'] += amount * value_rate
            ...
            move.foreign_amount_by_group = [
                (
                    ...
                    formatLang(
                        lang_env, 
                        amounts['foreign_base'] * move.order_line.filtered(lambda l: l.taxes_id.tax_group_id.id == group.id)[0].taxes_id.amount / 100,
                    ),
                   formatLang(
                        lang_env, 
                        amounts['foreign_base'],
